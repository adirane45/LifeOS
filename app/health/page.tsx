  ...
  return (
    <section className="space-y-6">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        ...
        <a href="/api/export/health" download className="inline-flex items-center justify-center rounded bg-gray-900 px-4 py-2 text-sm font-medium text-white transition hover:bg-gray-700">
          Export CSV
        </a>
      </div>
